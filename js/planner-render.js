...
// PATCHED: Added Recurrence Button
...
container.innerHTML = '';
if (!list.length) {
container.innerHTML = '<div class="text-zinc-500 text-center py-10">No events</div>';
return;
}
...
// NEW: Recurrence Button
const recurBtn = '<button class="text-zinc-400 hover:text-blue-400" onclick="event.stopPropagation(); showRecurModal(\'' + ev.id + '\')" title="Make Recurring">🔁</button>';
