...
async function updateTokenWithUsername(username) {
    ...
    try {
        ...
        // Do NOT send prefs here — backend preserves existing prefs
...
export function switchGuestbook(bookKey) {
    ...
    // ✅ PATCH: Tell the server which book this device is now watching
    // so push notifications are only sent for the active tab
    updateTokenActiveBook(bookKey);
    loadGuestbook();
}
